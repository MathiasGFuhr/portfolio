...
import {
  ...
    // if (n.includes("aws")) return "AWS"; // Removido dos ICONS
    // if (n.includes("gcp")) return "GCP"; // Removido dos ICONS
    // if (n.includes("azure")) return "Azure"; // Removido dos ICONS
    if (n.includes("gitlab")) return "GitLab";
    if (n.includes("github")) return "GitHub";
    if (n.startsWith("git")) return "Git";
    if (n.includes("figma")) return "Figma";
  // VSCode removido dos ICONS: mapear para JetBrains como fallback estável
  if (n.includes("vscode") || n.includes("visual studio code")) return "JetBrains";
  ...
    // if (n.includes("playwright")) return "Playwright"; // Removido dos ICONS
